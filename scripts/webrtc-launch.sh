...
if [ -f "$METADATA_FILE" ]; then
  ...
  export ROBOT_ID=$(jq -r '.ROBOT_ID // ""' "$METADATA_FILE")
  export SIGNALING_URL=$(jq -r '.SIGNALING_URL // ""' "$METADATA_FILE")
  export TURN_SERVER_URL=$(jq -r '.TURN_SERVER_URL // ""' "$METADATA_FILE")
  export TURN_SERVER_USERNAME=$(jq -r '.TURN_SERVER_USERNAME // ""' "$METADATA_FILE")
  export TURN_SERVER_PASSWORD=$(jq -r '.TURN_SERVER_PASSWORD // ""' "$METADATA_FILE")
else
